...
const App = () => {
  ...
  // --- AJUSTE PARA WHATSAPP (Desbloqueado para pantalla principal) ---
...
_¡Servicio completado con éxito!_ ✨`;
    ...
    // Este método es el que evita el bloqueo en la pantalla de inicio
    const win = window.open(url, '_blank', 'noopener,noreferrer');
    if (win) {
      win.focus();
    } else {
      // Si el navegador bloquea el popup, usamos esta alternativa
