      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <section className="mb-8 bg-white/80 backdrop-blur-md p-6 rounded-[3rem] shadow-xl border-2 border-pink-100 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex gap-3">
            {!cronometroActivo ? (
              <button onClick={() => setCronometroActivo(true)} className="bg-pink-500 text-white px-8 py-4 rounded-2xl font-black uppercase text-xs shadow-lg flex items-center gap-2"><Play size={16} fill="white" /> Iniciar</button>
            ) : (
              <button onClick={detenerYGuardarCronometro} className="bg-red-400 text-white px-8 py-4 rounded-2xl font-black uppercase text-xs shadow-lg flex items-center gap-2"><Square size={16} fill="white" /> Detener</button>
            )}
          </div>
        </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 space-y-8">
            <section className="bg-white/80 backdrop-blur-md p-10 rounded-[4rem] shadow-xl border border-pink-50 text-center">
              ...
              <button onClick={enviarWhatsApp} className="w-full bg-[#25D366] text-white py-6 rounded-[2.5rem] font-black uppercase tracking-widest text-sm shadow-xl flex items-center justify-center gap-4"><Send size={24} /> ENVIAR POR WHATSAPP</button>
            </section>
